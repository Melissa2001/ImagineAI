...
# Initialize text-to-speech engine outside the loop
engine = pyttsx3.init()
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        if confidence < 100:  # Adjust threshold as needed
            ...
            cv2.putText(im, f'{person_name} - {confidence:.2f}', (x-10, y-10), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 0))
            ...
            engine.say("Someone is in front of you")  
            engine.runAndWait() 
